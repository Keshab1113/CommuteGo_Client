...
const Heading = () => {
    return (
        <div className="  w-full h-screen flex justify-center items-center sm:flex-row flex-col-reverse"><video src={video} muted autoPlay loop className=" object-cover w-full h-screen" />
